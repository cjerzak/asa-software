...
## Not run: 
##D # Default Tor instance
##D ip <- get_tor_ip()
##D message("Current Tor IP: ", ip)
##D 
##D # Check specific Tor instance (e.g., for parallel jobs)
##D ip <- get_tor_ip(proxy = "socks5h://127.0.0.1:9055")
## End(Not run)
...
##D )
##D 
##D # Disable circuit breaker
##D results <- run_task_batch(prompts, agent = agent, circuit_breaker = FALSE)
##D 
##D # Abort on circuit breaker trip
##D results <- run_task_batch(prompts, agent = agent, abort_on_trip = TRUE)
## End(Not run)
