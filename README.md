...
<!-- SPEED_REPORT_START -->
**Last Run:** 2026-01-30 10:57:37 CST | **Status:** PASS

| Benchmark | Current | Baseline | Ratio | Status |
|-----------|---------|----------|-------|--------|
| `build_prompt` | 0.097s | 0.09s | 1.08x | PASS |
| `helper_funcs` | 0.050s | 0.07s | 0.71x | PASS |
| `combined` | 0.085s | 0.09s | 0.93x | PASS |
| `agent_search` | 21.7s | 18s | 1.23x | PASS |
