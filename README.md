...
<!-- SPEED_REPORT_START -->
**Last Run:** 2026-03-10 09:54:58 CDT | **Status:** PASS

| Benchmark | Current | Baseline | Ratio | Status |
|-----------|---------|----------|-------|--------|
| `build_prompt` | 0.134s | 0.09s | 1.49x | PASS |
| `helper_funcs` | 0.078s | 0.07s | 1.11x | PASS |
| `combined` | 0.117s | 0.09s | 1.29x | PASS |
| `agent_search` | 32.5s | 18s | 1.85x | PASS |
