...
<!-- SPEED_REPORT_START -->
**Last Run:** 2026-03-09 18:42:44 CDT | **Status:** PASS

| Benchmark | Current | Baseline | Ratio | Status |
|-----------|---------|----------|-------|--------|
| `build_prompt` | 0.130s | 0.09s | 1.44x | PASS |
| `helper_funcs` | 0.077s | 0.07s | 1.09x | PASS |
| `combined` | 0.115s | 0.09s | 1.26x | PASS |
| `agent_search` | 31.8s | 18s | 1.80x | PASS |
