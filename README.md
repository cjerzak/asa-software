...
<!-- SPEED_REPORT_START -->
**Last Run:** 2026-02-19 18:26:12 CST | **Status:** PASS

| Benchmark | Current | Baseline | Ratio | Status |
|-----------|---------|----------|-------|--------|
| `build_prompt` | 0.141s | 0.09s | 1.57x | PASS |
| `helper_funcs` | 0.076s | 0.07s | 1.09x | PASS |
| `combined` | 0.116s | 0.09s | 1.27x | PASS |
| `agent_search` | 30.9s | 18s | 1.75x | PASS |
