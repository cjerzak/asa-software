...
<!-- SPEED_REPORT_START -->
**Last Run:** 2026-01-30 11:39:00 CST | **Status:** PASS

| Benchmark | Current | Baseline | Ratio | Status |
|-----------|---------|----------|-------|--------|
| `build_prompt` | 0.095s | 0.09s | 1.06x | PASS |
| `helper_funcs` | 0.062s | 0.07s | 0.88x | PASS |
| `combined` | 0.093s | 0.09s | 1.03x | PASS |
| `agent_search` | 21.8s | 18s | 1.24x | PASS |
