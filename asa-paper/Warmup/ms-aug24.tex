...
\input{./FiguresParties/DataSamp.tex}
...
%I have asked Kanchan Chandra and Ishiyama for their data on ethnic parties. No word back from either, so far. Not sure if the former is public or if it was ever completed. Erzen: I can try to find this elsewhere. 
...
\input{./FiguresParties/tabEVTab_SEanalytical.tex}
