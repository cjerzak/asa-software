...
\large
\begin{itemize}
  \item Data is increasingly the \textbf{scarce, durable asset} in quantitative social science.
  \item \textbf{Analysis friction is falling:} LLMs reduce the cost of coding, cleaning, summarizing, and prototyping.
  \item As analysis gets cheaper, \textbf{unique data sources} become more valuable.
  \item Comparative advantage shifts toward \textbf{proprietary / hard-to-collect} datasets.
  \item Grounding examples (data companies with massive valuations/exits):
  \begin{itemize}
    \item[] \textbf{Scale AI} (training-data / labeling infrastructure)
    \item[] \textbf{ZoomInfo} (B2B contact and firmographic data)
    \item[] \textbf{CoStar} (commercial real-estate data)
  \end{itemize}
