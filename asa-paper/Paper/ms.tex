...
\begin{figure}[htb]
  ...
  \begin{tikzpicture}[
    ...
    \node[box, right=of input, text width=0.30\linewidth] (agent) {
      \textbf{Auditable Search Agent (ASA)}\\[-1pt]
