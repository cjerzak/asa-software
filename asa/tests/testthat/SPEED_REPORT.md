...
**Last Run:** 2026-02-19 20:03:57 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.0855s | 0.09s | 0.36s | 0.95x | PASS |
| helper_funcs | 0.0455s | 0.07s | 0.28s | 0.65x | PASS |
| combined | 0.0777s | 0.09s | 0.36s | 0.85x | PASS |
