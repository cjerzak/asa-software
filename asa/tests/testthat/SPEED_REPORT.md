...
**Last Run:** 2026-03-12 10:22:36 CDT
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.2291s | 0.09s | 0.36s | 2.55x | PASS |
| helper_funcs | 0.1421s | 0.07s | 0.28s | 2.03x | PASS |
| combined | 0.1961s | 0.09s | 0.36s | 2.16x | PASS |
