...
**Last Run:** 2026-05-24 18:36:56 EDT
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.1330s | 0.09s | 0.36s | 1.48x | PASS |
| helper_funcs | 0.0758s | 0.07s | 0.28s | 1.08x | PASS |
| combined | 0.1167s | 0.09s | 0.36s | 1.28x | PASS |
| agent_search | 41.3s | 18s | 70s | 2.34x | PASS |
