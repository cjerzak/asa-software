...
**Last Run:** 2026-02-27 12:40:14 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.1224s | 0.09s | 0.36s | 1.36x | PASS |
| helper_funcs | 0.0657s | 0.07s | 0.28s | 0.94x | PASS |
| combined | 0.1049s | 0.09s | 0.36s | 1.15x | PASS |
