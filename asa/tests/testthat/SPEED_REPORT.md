...
**Last Run:** 2026-02-05 09:49:50 CST
**Overall Status:** FAIL
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.0763s | 0.09s | 0.36s | 0.85x | PASS |
| helper_funcs | 0.0423s | 0.07s | 0.28s | 0.60x | PASS |
| combined | 0.0665s | 0.09s | 0.36s | 0.73x | PASS |
| agent_search | 98.2s | 18s | 70s | 5.58x | FAIL |
