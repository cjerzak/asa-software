...
**Last Run:** 2026-02-01 22:26:30 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.0756s | 0.09s | 0.36s | 0.84x | PASS |
| helper_funcs | 0.0474s | 0.07s | 0.28s | 0.68x | PASS |
| combined | 0.0732s | 0.09s | 0.36s | 0.80x | PASS |
| agent_search | 21.2s | 18s | 70s | 1.20x | PASS |
