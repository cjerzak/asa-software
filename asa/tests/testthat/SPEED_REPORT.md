...
**Last Run:** 2026-01-10 13:23:07 EST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.1209s | 0.09s | 0.36s | 1.34x | PASS |
| helper_funcs | 0.0732s | 0.07s | 0.28s | 1.05x | PASS |
| combined | 0.1098s | 0.09s | 0.36s | 1.21x | PASS |
| agent_search | 10.8s | 18s | 70s | 0.61x | PASS |
