...
**Last Run:** 2026-02-12 12:55:55 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.0844s | 0.09s | 0.36s | 0.94x | PASS |
| helper_funcs | 0.0512s | 0.07s | 0.28s | 0.73x | PASS |
| combined | 0.0761s | 0.09s | 0.36s | 0.84x | PASS |
| agent_search | 32.0s | 18s | 70s | 1.82x | PASS |
